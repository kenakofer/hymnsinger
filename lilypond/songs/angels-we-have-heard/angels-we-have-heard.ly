...
%%
%% The slides print one verse much larger and paginate a system per slide, so
%% the extra margin buys nothing and costs a 14th slide. The two shape-note
%% books run at shapeStaffZoom 1.1 and are already near the bottom of the page;
%% the margin tips them onto a second page.
spacing_overrides_by_book = #`(
  ("slides"     . #f)
  ("shapenote"  . #f)
  ("4shapenote" . #f))
