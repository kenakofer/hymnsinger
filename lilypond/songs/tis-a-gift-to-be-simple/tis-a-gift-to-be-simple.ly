...
soprano = {
  \globalParts
  \relative g' { \partial 4 c,8 c | f4 8 g a f a bf | c4 8 bf a4 g8 f | g4 g g f | g8 a g f c4 } \break
  \relative g' { c,4 | f8 e f g a( f) a bf | c4 8( bf) a4 g8( f) | g4 8 8 a4 8 g | f4 8 8 f4 r } \break
  \relative g' { c2 a4. g8 | a bf a g f4. g8 | a4 8 bf c4 bf8 a | g4 g8 a g4 } \break
  \relative g' { r8 c, | f2 a4. bf8 | c4 8 bf a4 g8 f | g4 g a4 8 g | f4 f f } \break
  \bar "|." 
}
alto = {
  \globalParts
