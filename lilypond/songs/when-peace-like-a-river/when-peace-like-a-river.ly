...
soprano = {
  ...
  \relative g' { g4 | c2 b4 a | a2 g4 fs | g2. } \break
  \relative g' { g4 | c2 4 b | a2 4 4 | d2 4 c | b2 } \break
  \relative g' { a4 g | c2 4 4 | c2 b4. c8 | c2 \bar "||" } \break
  \relative g' { g4 g | 1~ | 2 4 4 | 1~ | 2 e4 g | a2 4 c | c2 b4. c8 | c2. } \break
  \bar "|."
}
alto = {
  \globalParts
