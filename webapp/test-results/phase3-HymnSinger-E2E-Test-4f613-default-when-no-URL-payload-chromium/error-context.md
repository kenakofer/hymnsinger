...
- Name: phase3.spec.ts >> HymnSinger E2E Tests - Phase 3 >> Input Visibility Toggle >> should show input area by default when no URL payload
- Location: e2e/phase3.spec.ts:83:9
