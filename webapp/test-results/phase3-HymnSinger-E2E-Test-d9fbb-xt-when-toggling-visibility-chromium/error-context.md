...
- Name: phase3.spec.ts >> HymnSinger E2E Tests - Phase 3 >> Input Visibility Toggle >> should update button text when toggling visibility
- Location: e2e/phase3.spec.ts:121:9
